...
<footer class="main">
	<div class="fbox">
		<div class="fcmpbox">
			...
			<?php } ?>
			<div class="copy"><?php echo $copyright; ?> | Theme by <a href="https://www.moviestreamingscripts.com" title="Movie Streaming Scripts - everything for your streaming website">MSS</a></div>
